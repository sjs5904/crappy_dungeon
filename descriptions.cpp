...
const std::string object_typeName[] = {
  "No type: ", /* objtype_no_type */
  "Weapon: ", /* objtype_WEAPON */
  "Offhand: ", /* objtype_OFFHAND */
  "Ranged: ", /* objtype_RANGED */
  "Light: ", /* objtype_LIGHT */
  "Armor: ", /* objtype_ARMOR */
  "Helmet: ", /* objtype_HELMET */
  "Cloak: ", /* objtype_CLOAK */
  "Gloves: ", /* objtype_GLOVES */
  "Boots: ", /* objtype_BOOTS */
  "Amulet: ", /* objtype_AMULET */
  "Ring: ", /* objtype_RING */
};
